...
public class BudgetAggregate : Aggregate, IEntity<BudgetId>
{
	...
	{
		this.CheckRule(new BudgetCannotHaveNameStartedWithBrokenRuleBusinessRule(name));
	...
	/// <param name="icon">Budget Icon.</param>
	public void EditBudget(BudgetId id, string name, Period period, string description, string icon)
	{
		var budgetEdited = new BudgetEditedDomainEvent(id, name, period, description, icon);
