...
public class BudgetTransactionCreatedDomainEvent : DomainEvent
{
	...
	public BudgetTransactionCreatedDomainEvent(TransactionId transactionId, BudgetId budgetId, TransactionType transactionType, string name, decimal value, CategoryType categoryType, DateTime transactionDate, Status status)
	{
