...
public record CreateBudgetTransaction(TransactionTypes Type, Guid Id, Guid BudgetId, string Name, decimal Value, Categories Category, DateTime TransactionDate) : ICommand;
