...
public record CreateBudget(Guid Id, string Name, DateTime StartDate, DateTime EndDate, Currency Currency, decimal Limit, string Description, string IconName) : ICommand;
