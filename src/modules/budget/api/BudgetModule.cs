...
using Intive.Patronage2023.Modules.Budget.Infrastructure.Domain.EventHandlers;
...
public static class BudgetModule
{
	...
	public static IServiceCollection AddBudgetModule(this IServiceCollection services, ConfigurationManager configurationManager)
	{
		...
		services.AddSingleton<IDomainEventHandler<BudgetCreatedDomainEvent>, BudgetCreatedDomainEventHandler>();
		services.AddSingleton<IDomainEventHandler<BudgetNameUpdatedDomainEvent>, BudgetNameUpdatedDomainEventHandler>();
