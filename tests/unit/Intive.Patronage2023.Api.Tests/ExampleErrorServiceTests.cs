...
/// </summary>
{
    public class ExampleErrorServiceTests
    {
        ...
        {
            errorService = new ExampleErrorService();
        }
        ...
        {
            // Act & Assert
            FluentActions.Invoking(errorService.ThrowAppException)
                .Should()
                .Throw<AppException>()
        ...
        /// <summary>
        /// Test that verifies if 'FileNotFoundException' is correctly thrown.
        /// </summary>
        [Fact]
        public void ThrowFileNotFoundException_ShouldThrowFileNotFoundException()
        {
            // Act & Assert
            FluentActions.Invoking(errorService.ThrowFileNotFoundException)
                .Should()
                .Throw<FileNotFoundException>()
                .WithMessage("The page could not be found.");
        }
        /// <summary>
        ...
        {
            // Act & Assert
            FluentActions.Invoking(errorService.ThrowUnauthorizedAccessException)
                .Should()
        ...
        {
            // Act & Assert
            FluentActions.Invoking(errorService.ThrowAuthenticationException)
                .Should()
        ...
        {
            // Act & Assert
            FluentActions.Invoking(errorService.ThrowException)
                .Should()
                .Throw<Exception>()
