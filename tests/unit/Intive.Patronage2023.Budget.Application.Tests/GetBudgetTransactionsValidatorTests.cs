...
public class GetBudgetTransactionsValidatorTests
{
	...
	public async Task Validate_WhenBudgetIdDoesNotExistInDatabase_ShouldHaveValidationErrorForBudgetId()
	{
		...
		var sortDescriptors = new List<TransactionSortDescriptor>() { new TransactionSortDescriptor { Column = 0, SortAscending = true }, new TransactionSortDescriptor { Column = 3, SortAscending = false } };
